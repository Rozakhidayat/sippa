        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Edit Data User</h1>
                    ...
                    <form class="row g-3" wire:submit.prevent='save'>
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('form.name') is-invalid @enderror"
                                id="unitKerja" wire:model.lazy='form.name'>
                            @error('form.name')
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('form.no_badge') is-invalid @enderror"
                                id="no_badge" wire:model.lazy='form.no_badge'>
                            @error('form.no_badge')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <select wire:model.lazy='form.role_id' id="role_id"
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div class="list-group list-group-flush"
                                        ...
                                        <label
                                            ...
                                            wire:click="$set('form.departement_id', {{ $departement->id }})"
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" class="form-control @error('form.email') is-invalid @enderror"
                                id="email" wire:model.lazy='form.email'>
                            @error('form.email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="password" class="form-control @error('form.password') is-invalid @enderror"
                                id="password" wire:model.lazy='form.password'>
                            @error('form.password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="password"
                                ...
                                id="password" wire:model.lazy='form.password_confirmation'>
