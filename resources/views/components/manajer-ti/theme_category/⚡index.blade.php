...
<div>
    <main id="main" class="main">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($this->categories as $categori)
                                    <tr>
                                        <td>
                                            {{ $categori->name }}
                                        </td>
                                        <td>
                                            <button wire:click='edit({{ $categori->id }})'
                            ...
                            {{ $this->categories->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Modal -->
        <livewire:manajer-ti.theme_category.create />
        <livewire:manajer-ti.theme_category.edit />
    </main>
    <x-alert />
</div>