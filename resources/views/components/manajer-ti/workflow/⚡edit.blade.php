...
new class extends Component
{
    ...
    public function load(int $id)
    {
        ...
        $this->form->setWorkflow($workflow);
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Edit Workflow</h1>
                    ...
                    <form class="row g-3" wire:submit.prevent='save'>
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('form.label') is-invalid @enderror"
                                id="workflow" wire:model='form.label'
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control bg-light @error('form.state_code') is-invalid @enderror"
