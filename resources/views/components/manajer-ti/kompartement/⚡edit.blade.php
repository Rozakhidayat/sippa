...
new class extends Component
{
    ...
    public function load(int $id)
    {
        ...
        $this->form->setKompartement($kompartement);
    ...
    {
        $this->form->update();
        $this->dispatch('editedKompartement');
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Edit Data Kompartement</h1>
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div class="list-group list-group-flush"
                                        ...
                                        <label
                                            ...
                                            wire:click="$set('form.direktorat_id', {{ $item->id }})"
                                            @click="open = false">

                                            <input class="d-none" type="radio" value="{{ $item->id }}">
                                            {{ $item->name }}
                                        </label>
                                        @empty
