...
new class extends Component
{
    ...
    public function render()
    {
        ...
        if (!in_array('perbaikan_brd', $allowedWorkflowStates)) {
        $allowedWorkflowStates[] = 'perbaikan_brd';
        }
                                    ...
                                    <tr class="border-bottom">
                                        ...
                                        <td>
                                            <span class="badge bg-success px-2 py-1" style="font-weight: 500;">{{
                                                $submission->type_development}}</span>
                                        </td>
                                        ...
                                        <td class="text-center pe-3">
                                            <a href="{{ route('bp.pengajuan.show', $submission->no_ticket) }}"
                                                wire:navigate
