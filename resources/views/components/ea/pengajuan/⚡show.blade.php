...
new class extends Component
{
    ...
    public function confirmAction(string $type)
    {
        ...
        if ($type == 'setuju')
        {
            $this->last_remark = 'Disetujui oleh Enterprise Architect';
            $this->submitAction();
        }else{
    ...
    public function submitAction()
    {
        ...
        return $this->redirectRoute('ea.pengajuan', navigate: true);
    }
...
<div>
    <main id="main" class="main">
        <div class="pagetitle mb-3 d-flex justify-content-between align-items-center">
            ...
            <a href="/ea/pengajuan" wire:navigate class="btn btn-danger btn-sm">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm p-4">
                        ...
                        <button wire:click="downloadBRD" wire:loading.attr="disabled" class="btn btn-primary btn-sm">
                            <span wire:loading wire:target="downloadBRD" class="spinner-border spinner-border-sm me-1"
