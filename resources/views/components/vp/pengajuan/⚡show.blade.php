...
new class extends Component
{
    ...
    public function confirmAction(string $type)
    {
        ...
        if ($type == 'setuju')
        {
            $this->last_remark = 'Disetujui oleh VP Unit Kerja';
            $this->submitAction();
        }else{
    ...
    public function submitAction()
    {
        ...
        return $this->redirect('/vp/approval', navigate: true);
    }
...
<div>
    <main id="main" class="main">
        <div class="pagetitle mb-3 d-flex justify-content-between align-items-center">
            ...
            <a href="/vp/approval" wire:navigate class="btn btn-danger btn-sm">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm p-4 mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            return $theme->category ? $theme->category->name : 'tanpa category';
                            });
                            @endphp
